...
<div> 
  <h3><b>Daftar Murid Kelas 1</b></h3>
    <br>
    <br>
    <br>
        ...
        <tbody>
          ...
          //error_reporting(0);
            ...
            $query = mysqli_query($konek, "SELECT a.nama, a.id_siswa from siswa a 
                                          ...
                                          WHERE c.nama_kelas = 'Kelas 1'")or die(mysqli_error());
                    ...
                    { 
                      ...
                      while($data = mysqli_fetch_array($query)){  
                        ...
                        echo '<td  width="20"><a data-toggle="tooltip" data-placement="left" title="Edit" href=index.php?content=Daftar_hafalan&&id_siswa='.$data['id_siswa'].'><i class="pe-7s-note"></i></a></td>';
