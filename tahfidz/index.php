    ...
    -->
        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="index.php?content=daftar">
                ...
                <li>
                    <a href="index.php?content=nilai">
                        <i class="pe-7s-id"></i>
                        <p>Nilai Hafalan</p>
                    </a>
                </li>
                        ...
                        <div class="card">
                            <div class="content">
                                <?php
                                    ...
                                    if ($content=='kelas6')
                                    include 'kelas6.php';
                                    if ($content=='Daftar_hafalan')
                                    include 'Daftar_hafalan.php';
                                    if ($content=='isi_nilai')
                                    include 'isi_nilai.php';
                                    if ($content=='edit_nilai')
                                    include 'edit_nilai.php';
                                    if ($content=='list_cetak')
                                    include 'list_cetak.php';
                                    if ($content=='cetak_nilai_hafalan')
                                    include 'cetak_nilai_hafalan.php';
