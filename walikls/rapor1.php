...
<hr>
    ...
    <h5>Untuk Mengisi Nilai Matapelajaran</h5>
    <br>
            ...
            $query = mysqli_query($konek, $sql)or die(mysqli_error());
                    ...
                    { 
                      ...
                      while($data = mysqli_fetch_array($query)){  
                        ...
                        echo '<td  width="20"><a data-toggle="tooltip" data-placement="left" title="tambah" href=index.php?content=pilihan_nilai&&id_siswa='.$data['id_siswa'].'&&id_kelas='.$data['id_kelas'].'><i class="pe-7s-album"></i></a></td>';
                        echo '</tr>';
                        $no++;  
                      }
                    }
