...
<hr>
    ...
    <h5>Pilih siswa untuk mencetak Identitas</h5>
    <br>
            ...
            $query = mysqli_query($konek, $sql)or die(mysqli_error());
                    ...
                    { 
                      ...
                      while($data = mysqli_fetch_array($query)){  
                        ...
                        echo '<td  width="20"><a data-toggle="tooltip" data-placement="left" title="tambah" href=index.php?content=pilihan_cetak&&id_siswa='.$data['id_siswa'].'&&id_kelas='.$data['id_kelas'].'><i class="pe-7s-album"></i></a></td>';
                        echo '</tr>';
                        $no++;  
                      }
                    }
            ...
            $query = mysqli_query($konek, $sql)or die(mysqli_error());
                    ...
                    { 
                      ...
                      while($data = mysqli_fetch_array($query)){  
                        ...
                        echo '<td>'.$data['nama'].'</td>';
                        echo '<td>'.$data['no_induk'].'</td>';
                        echo '<td  width="20"><a data-toggle="tooltip" data-placement="left" title="tambah" href=index.php?content=pilihan_cetak1&&id_siswa='.$data['id_siswa'].'&&id_kelas='.$data['id_kelas'].'><i class="pe-7s-album"></i></a></td>';
                        echo '</tr>';
                        $no++;  
                      }
                    }
